...
- добавлен третий полноценный диалог «Любовь — Последняя ложь / Lyubov — The Last Lie» о супружеской измене, признании и последствиях решений;
- игрок начинает разговор доказательством, после чего выбирает один из пяти разных первых ответов Любови;
- реализованы 49 узлов, 9 достижимых концовок и маршруты продолжительностью 40–50 минут для основных веток;
- добавлены локализованные вложения: дальние фото-доказательства, скриншоты чата, пересланные сообщения и вымышленные документы;
- фото у гостиницы сняты визуально с большого расстояния через парковку; лица и интимные детали не используются;
- добавлен полноэкранный адаптивный просмотрщик вложений с закрытием через Escape/Back и поддержкой mobile/desktop/TV;
- русская и английская версии используют одинаковые stable IDs, graph, effects и endings;
- добавлены story bible, карты лжи и доказательств, хронология, attachment audit и автоматические сценарные маршруты;
- промо-защита запрещает использовать сюжетные доказательства Любови в каталожных скриншотах;
- 103 автоматических теста проходят, включая все концовки Любови, RU/EN parity, вложения, длительность и production promo guard.
